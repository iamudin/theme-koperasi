<section class="max-w-7xl mx-auto px-4 py-10">
  <div class="grid lg:grid-cols-3 gap-8">
    <div class="lg:col-span-2">
      <div class="text-sm text-slate-500 dark:text-slate-400">Arsip</div>
      <h1 class="mt-1 text-2xl font-bold text-slate-900 dark:text-slate-100">{{ $title ?? 'Arsip Berita' }}</h1>
